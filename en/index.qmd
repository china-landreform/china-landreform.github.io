...
::: {.map-image-wrap}
[![](../assets/images/county_land_reform_experience_en.png){.coverage-map-image fig-alt="County-level Land Reform Experience Map"}](../assets/images/county_land_reform_experience_en.png){target="_blank"}
:::
:::
